...
export const FaqCard = ({ question, answer }: { question: string; answer: string }) => {
  return (
    <div className="flex flex-col items-start gap-4 p-6 bg-white rounded-lg shadow-lg w-96 flex-shrink-0 faq-card border border-neutral-100">
 ...
 */
const FaqSection = ({ data }: { data: FaqDataType }) => {
  return (
